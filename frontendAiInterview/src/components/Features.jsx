  ...
  return (
    <Card sx={{ 
      ...
      <CardContent sx={{ p: 3, height: '100%' }}>
        ...
        <Typography variant="h6" component="h3" gutterBottom sx={{ color: 'white', fontWeight: 600, mb: 1.5 }}>
          {title}
        </Typography>
...
const Features = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Get detailed feedback on your answers, You can check all the feedback from your dashboard',
      color: '#00b8d4'
    },
    {
      icon: VoiceIcon,
      title: 'Speech Recognition',
      description: 'Our advanced speech-to-text technology accurately captures your responses.',
      color: '#00e5c9'
    },
    {
      icon: FeedbackIcon,
      title: 'Instant Feedback',
      description: 'Receive immediate, actionable feedback to improve your interview skills.',
      color: '#00b8d4'
    },
  ];
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              >
                ...
                <Typography variant="h5" component="h3" sx={{ color: 'white', mb: 2, fontWeight: 600 }}>
                  {feature.title}
                </Typography>
              ...
              {[
                {
                  ...
                  description: 'Practice with real-world coding problems and get instant feedback on your solutions.',
                  icon: '💻',
                  color: '#ff6b6b'
                },
                {
                  title: 'Company-Specific Mocks',
                  description: 'Prepare for interviews at top tech companies with our specialized mock interviews.',
                  icon: '🏢',
                  color: '#4ecdc4'
                },
                {
                  title: 'AI-Powered Feedback',
                  description: 'Get detailed analysis of your problem-solving approach.',
                  icon: '🤖',
                  color: '#ff9f43'
                },
              ].map((feature, index) => (
                <Grid item xs={12} sm={6} md={3} key={index}>
                  ...
                  >
                    ...
                    <Typography variant="h6" component="h3" sx={{ color: 'white', mb: 1.5, fontWeight: 600 }}>
                      {feature.title}
                    </Typography>
                    <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.7)' }}>
                      {feature.description}
